...
class WaveControlGUI(Gtk.Window):
    def __init__(self):
        ...
        self.set_title("WaveControl - Windows")
    ...
    def setup_ui(self):
        ...
        # Título da aplicação
        title_label = Gtk.Label(label="WaveControl - Windows")
        ...
        footer_info = Gtk.Label(label="WaveControl Windows - Controle por gestos | Criado por Karan Luciano")
